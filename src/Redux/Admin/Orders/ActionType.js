...
// Action types for success order
export const SUCCESS_ORDER_REQUEST = "SUCCESS_ORDER_REQUEST";
export const SUCCESS_ORDER_SUCCESS = "SUCCESS_ORDER_SUCCESS";
export const SUCCESS_ORDER_FAILURE = "SUCCESS_ORDER_FAILURE";
